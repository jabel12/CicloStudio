...
<header>
        <div class="container">
          <div class="brand">
            <h1 class="brand_name"><a href="./">CicloStudio</a></h1>
            <p class="brand_slogan">El mejor lugar para entrenar</p>
      ...
      <footer>
            ...
            <ul class="row contact-list">
              ...
              <li class="grid_4">
                <div class="box">
                  ...
                  <div class="box_cnt__no-flow"><a target="_blank" href="http://www.facebook.com">Follow on facebook</a></div>
                </div>
                <div class="box">
                  <div class="box_aside">
        ...
        <section>
          <div class="container">
            <div class="copyright">Business Company © <span id="copyright-year"></span>.&nbsp;&nbsp;<a >CicloStudio</a>
            </div>
          </div>
        </section>
      </footer>
